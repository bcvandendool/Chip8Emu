...
// 0x050 - 0x0A0 - pixel font set
// 0x200 - 0xFF - program ROM and RAM
...
void executeOP()
{
    ...
    switch(opcode & 0xF000)
    {
        ...
        //The interpreter generates a random number from 0 to 255, which is the n ANDed with the value ll. The results are stored in Vx. See instruction 8xy2 for
